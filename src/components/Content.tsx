...
export default function Content() {
  ...
  return (
    <div className="bg-[#212121] w-full h-screen transition duration-300 flex items-center justify-center relative">
      <div
        className="w-[40px] h-[40px] hover:bg-[#2f2f2f] p-[8px] rounded-[8px] cursor-pointer absolute left-[12px] top-[8px]"
      ...
      <span className="text-[#ececec] font-roboto-regular">
        Terapkan kelas font Roboto ke elemen body di dalam komponen
      </span>
    </div>
  );
}

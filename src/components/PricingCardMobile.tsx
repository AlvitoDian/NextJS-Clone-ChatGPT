...
export default function PricingCardMobile({
  ...
  return (
    <div
      className={`flex flex-col justify-between pl-[24px] pr-[25px] py-[16px] border-[1px] border-[#3e3e3e] h-[462px] mx-[12px] rounded-[12px]`}
    >
      <div>
        <div>
      ...
      <div className="">
        ...
        {id === 3 && (
          <div className="text-[12px] leading-[16px] text-[#e3e3e3]">
            * Harga ditagih per tahun, minimum 2 pengguna
          </div>
        )}
      </div>
    </div>
